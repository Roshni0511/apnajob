...
const TermsandCondition = () => {
  return (
    <>
      ...
      <p className="mt-2" style={{fontSize:'16px', textAlign:'justify'}}>
      ...
      <ul className="list-disc ml-6 mt-2">
        <li style={{fontSize:'16px', textAlign:'justify'}}>Users must ensure all information provided is accurate and truthful.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Unauthorized access or misuse of JobHub’s services is strictly prohibited.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Violation of these terms may lead to legal actions or permanent suspension.</li>
      </ul>
