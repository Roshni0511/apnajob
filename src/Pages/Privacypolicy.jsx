...
const Privacypolicy = () => {
  return (
    <>
      ...
      <p className=" mb-4" style={{fontSize:'16px', textAlign:'justify'}}>
      ...
      <ul className="list-disc list-inside  mb-4">
        <li style={{fontSize:'16px', textAlign:'justify'}}>Device details: Type of mobile phone, operating system, and service providers.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Technical details: IP address, browser type, referral sources, and browsing patterns.</li>
      </ul>
      ...
      <ul className="list-disc list-inside  mb-4" style={{lineHeight:'32px'}}>
        <li style={{fontSize:'16px', textAlign:'justify'}}><strong>Identity Information:</strong> Name, date of birth, gender, username.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}><strong>Contact Information:</strong> Mobile number, postal address, email, and telephone number.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}><strong>Professional Information:</strong> Education, work experience, skills, salary, city, area, and resume details.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}><strong>Feedback & Correspondence:</strong> Survey responses, customer support queries, and feedback.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}><strong>Usage & Marketing Information:</strong> Interactions with our services, preferences, and engagement with marketing communications.</li>
      </ul>
      ...
      <ul className="list-disc list-inside  mb-4" style={{lineHeight:'32px'}}>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Contacts List: To suggest connections and expand your professional network.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Location Information: To provide location-based job search services.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Storage Access: To allow users to upload profile pictures from their device gallery.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Camera Access: To enable users to capture and upload profile photos.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Microphone Access: To facilitate audio messages within the app.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Call Access: To enable users to contact recruiters via the Call HR feature.</li>
        <li style={{fontSize:'16px', textAlign:'justify'}}>Marketing & Communication: To send job alerts and updates based on user preferences.</li>
      </ul>
      ...
      <p className=" font-semibold" style={{fontSize:'16px',marginBottom:'5px', textAlign:'justify'}}>JobHubtime Tech Private Limited</p>
      <p className="" style={{fontSize:'16px',marginBottom:'5px', textAlign:'justify'}}>3rd Floor, 23, Plot No. 232, 1-Kangra Bhuvan,</p>
      <p className="" style={{fontSize:'16px',marginBottom:'5px', textAlign:'justify'}}>Dr. Annie Besant Road, Worli, Mumbai, Maharashtra, 400030</p>
      <p className="" style={{fontSize:'16px',marginBottom:'5px', textAlign:'justify'}}>Email: <a href="mailto:JobHub-playstore@JobHub.co" className="text-blue-500">JobHub-playstore@JobHub.co</a></p>
    </div>
        </div>
        </main>
       <Footer />
